...
//Command     : generate_target design_library.bd
//Design      : design_library
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "design_library,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_library,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=14,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=13,da_board_cnt=13,da_clkrst_cnt=6,da_microblaze_riscv_cnt=3,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_library.hwdef" *) 
module design_library
   (lcd_bus_tri_o,
    ...
    usb_uart_rxd,
    usb_uart_txd);
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 lcd_bus TRI_O" *) (* X_INTERFACE_MODE = "Master" *) output [5:0]lcd_bus_tri_o;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN design_library_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  ...
  design_library_axi_gpio_0_2 axi_gpio_lcd
       (.gpio_io_o(lcd_bus_tri_o),
  ...
  design_library_axi_quad_spi_0_2 axi_quad_spi_0
       (.ext_spi_clk(microblaze_riscv_0_Clk),
        ...
        .sck_i(spi_rtl_0_sck_i),
        .sck_o(spi_rtl_0_sck_o),
        .sck_t(spi_rtl_0_sck_t),
        .ss_i(spi_rtl_0_ss_i),
        .ss_o(spi_rtl_0_ss_o),
        .ss_t(spi_rtl_0_ss_t));
  design_library_axi_smc_2 axi_smc
  ...
  design_library_axi_timer_0_2 axi_timer_0
       (.capturetrig0(1'b0),
        .capturetrig1(1'b0),
        .freeze(1'b0),
        .s_axi_aclk(microblaze_riscv_0_Clk),
  ...
  design_library_axi_uartlite_0_3 axi_uartlite_0
       (.rx(usb_uart_rxd),
        .s_axi_aclk(microblaze_riscv_0_Clk),
        ...
        .tx(usb_uart_txd));
  design_library_clk_wiz_1 clk_wiz
       (.clk_in1(sys_clock),
        .clk_out1(microblaze_riscv_0_Clk),
        .reset(reset));
  design_library_mdm_1_2 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "riscv > design_library microblaze_riscv_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  design_library_microblaze_riscv_0_2 microblaze_riscv_0
  ...
  microblaze_riscv_0_local_memory_imp_16ZTUUJ microblaze_riscv_0_local_memory
  ...
  design_library_proc_sys_reset_0_2 proc_sys_reset_0
       (.aux_reset_in(1'b1),
...
module microblaze_riscv_0_local_memory_imp_16ZTUUJ
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > design_library microblaze_riscv_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  design_library_dlmb_bram_if_cntlr_2 dlmb_bram_if_cntlr
  ...
  design_library_dlmb_v10_2 dlmb_v10
       (.LMB_ABus(microblaze_riscv_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_dlmb_bus_WAIT));
  design_library_ilmb_bram_if_cntlr_2 ilmb_bram_if_cntlr
  ...
  design_library_ilmb_v10_2 ilmb_v10
       (.LMB_ABus(microblaze_riscv_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_ilmb_bus_WAIT));
  design_library_lmb_bram_2 lmb_bram
